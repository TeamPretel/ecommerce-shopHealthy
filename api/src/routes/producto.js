...
router.get('/', async (req, res) => {
  ...
  if (nombre) {
    const productoFiltrado = todosLosProductos.filter( prod => prod.nombre.toLowerCase().includes(nombre.toLowerCase()))
...
router.get('/:id', async (req, res) => {
  ...
  try {
    const productodetalle = await Producto.findByPk(id.toUpperCase(), {
